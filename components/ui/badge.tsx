  ...
  "inline-flex items-center rounded-full border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        win: "border-transparent bg-green-500 text-neutral-50 hover:bg-green-500/80 dark:bg-green-900 dark:text-neutral-50 dark:hover:bg-green-900/80",
        ai: "border border-purple-500 bg-transparent text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600",
      },
    },
    defaultVariants: {
      variant: "default",
